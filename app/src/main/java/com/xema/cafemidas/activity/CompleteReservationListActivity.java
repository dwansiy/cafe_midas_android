...
public class CompleteReservationListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complete_reservation_list);
        mContext = this;
    ...
    private void getServerData() {
        ...
        ApiUtil.getOrderService().getOrderList(PreferenceHelper.loadId(mContext), PreferenceHelper.loadPw(mContext), 1).enqueue(new Callback<List<Order>>() {
            @Override
